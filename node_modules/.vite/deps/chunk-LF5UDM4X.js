...
var selectClasses2 = generateUtilityClasses2(COMPONENT_NAME13, ["root", "button", "listbox", "popup", "active", "expanded", "disabled", "focusVisible"]);
...
var Slider = React53.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime36.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime35.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime35.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index2) => {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LF5UDM4X.js.map
